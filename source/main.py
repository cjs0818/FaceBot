...
#
#   Face Detection: dlib.get_frontal_face_detector() (<- fd_dlib.py)
#   Face Recognition: fr_dlib.py
#   Head Pose Detection: hd_detection.py
#   Action Event Detection: action_detection.py
# ----------------------------------------------
# ----------------------------------------------------------
#  You need to setup PYTHONPATH
#    export PYTHONPATH=/Users/jschoi/work/ChatBot/FaceBot/source:$PYTHONPATH
# ----------------------------------------------------------
...
#-------------------------------------------------------------
# dialogflow.py  for Dialogflow chatbot platform
from Planner.Dialogue.dialogflow import ChatBot   # Chatbot platform: Dialogflow.ai
from Behavior_Perception.Percept_Speech.gspeech import Gspeech     # STT: Google Cloud Speech
import json
...
from Behavior_Perception.Percept_Face.fr_dlib import FaceRecog
...
from Behavior_Perception.Percept_Face.hp_detection import HeadPose


# ----------------------------
#   Action Event Detection: action_detection/action_detection.py
from Behavior_Perception.Percept_Gesture.action_detect import Event_Detector
ACTION_STATE_IDLE = 0
...
from Utils.Tracker.obj_tracker import Obj_Tracker

# ----------------------------
# To Play Video: The first frame
from Behavior_Expression.Act_Face.play_animation import Play_AV
...
# -----------------------
# Database
from Knowledge.Database.database import Database, MongoDB
...
#                "여진구 박사님이요",
    ...
    # ----------------------------
    # Head Pose Detection: by Dlib
    predictor_path = BASE_DIR + "/Behavior_Perception/Percept_Face/shape_predictor_68_face_landmarks.dat"
    hpd = HeadPose(sample_frame, predictor_path)


    # ------------------------------------------
    # Dlib: Load labels_id & face_descriptors of registered faces
    predictor_path = BASE_DIR + "/Behavior_Perception/Percept_Face/shape_predictor_5_face_landmarks.dat"
    face_rec_model_path = BASE_DIR + "/Behavior_Perception/Percept_Face/dlib_face_recognition_resnet_model_v1.dat"
    ...
    # ------------------------
    # Load Database
    filename = BASE_DIR + "/Knowledge/Database/RMI_researchers.csv"
    C_db = Database()
