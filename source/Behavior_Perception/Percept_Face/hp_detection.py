...
from Behavior_Perception.Percept_Face.mark_detector import MarkDetector
from Behavior_Perception.Percept_Face.pose_estimator import PoseEstimator
from Behavior_Perception.Percept_Face.stabilizer import Stabilizer


class HeadPose():
    def __init__(self, sample_frame, predictor_path = "./shape_predictor_68_face_landmarks.dat"):
        ...
        self.mark_detector = MarkDetector(BASE_DIR + "/assets/frozen_inference_graph.pb")
